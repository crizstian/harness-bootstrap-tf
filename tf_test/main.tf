...
resource "harness_platform_pipeline" "example" {
  identifier = "harness_seed_setup_1wHy"
  org_id     = "cristian_lab_infrateam_org_1wHy"
  project_id = "seed_project_cristian_lab_infrateam_org_1wHy"
  name       = "harness_seed_setup"

  yaml = <<-EOT
    pipeline:
        name: harness_seed_setup
        identifier: harness_seed_setup_1wHy
        projectIdentifier: seed_project_cristian_lab_infrateam_org_1wHy
        orgIdentifier: cristian_lab_infrateam_org_1wHy
        tags: {}
        stages:
            - stage:
                name: Terraform STO
                ...
                template:
                templateRef: account.terraform_sto_stage_template_IqdH
                versionLabel: beta
                templateInputs:
                    type: CI
                    variables:
                            ...
                            - step:
                                ...
                                configuration:
                                    ...
                                    store:
                                        ...
                                        spec:
                                        gitFetchType: Branch
                                        connectorRef: account.infrateam_github_connector_1wHy
